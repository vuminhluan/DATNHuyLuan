...
{{-- 	<script>console.log($listthongbao);
</script> --}}
<input type="hidden" id="xkx" name="" value="{{$listthongbao}}">
...
{{-- 	@break --}}
@endif
{{-- @if ($listthongbao[$i]->ma_loai_thong_bao=="LTBN02"&&$soluongthongbaodadoc[$j]->ma_nguoi_doc!=Auth::user()->ma_tai_khoan)
	<div class="thongbaodiv"  id="divtb-{{$listthongbao[$i]->ma_thong_bao}}" onclick="openbaivietduocthongbao('{{$listthongbao[$i]->noi_nhan_tac_dong}}','{{$listthongbao[$i]->noi_dung_tac_dong}}','{{$listthongbao[$i]->ma_thong_bao}}')" >
		<div style="width: 20%;float: left;padding-left: 15px;">
			<img style="width: 69px;height: 69px;border-radius: 50%;overflow: hidden;" 
			src="{{ asset('pictures/anh_dai_dien/'.$listthongbao[$i]->anhdaidiennguoitaothongbao)}} " alt="AVT">
...
@if ($listthongbao[$i]->ma_loai_thong_bao=="LTBN03")
	<div class="thongbaodiv"  id="divtb-{{$listthongbao[$i]->ma_thong_bao}}" onclick="openbinhluanbaivietduocthongbao('{{$listthongbao[$i]->noi_dung_tac_dong}}','{{$listthongbao[$i]->ma_thong_bao}}')" >
		<div style="width: 20%;float: left;padding-left: 15px;">
			<img style="width: 69px;height: 69px;border-radius: 50%;overflow: hidden;" 
			src="{{ asset('pictures/anh_dai_dien/'.$listthongbao[$i]->anhdaidiennguoitaothongbao)}} " alt="AVT">
		</div>
...
@if ($listthongbao[$i]->ma_loai_thong_bao=="LTBN04")
				<div class="thongbaodiv" id="divtb-{{$listthongbao[$i]->ma_thong_bao}}" onclick="openrepbinhluanbaivietduocthongbao('{{$listthongbao[$i]->noi_nhan_tac_dong}}','{{$listthongbao[$i]->ma_thong_bao}}')" >
