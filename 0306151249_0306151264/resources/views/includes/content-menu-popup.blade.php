...
{{--                             @if ($lstnhomcuataikhoan[$i]->anh!="no")
                            ...
                            @endif --}}
                                <div class="div-name-nhom"  style="height: 35px; width: 120px;text-align: center;margin-left: -37px;margin-top: 53px;overflow: hidden;font-weight: bold;text-overflow: ellipsis;">{{$lstnhomcuataikhoan[$i]->ten_nhom}}</div>
                            ...
                            <div style="height: 130px;width: 90px; margin: 7px;" onclick='gotogroup("{{$lstNhomQuanLyCuaTaiKhoan[$i]->ma_nhom}}")' >
                             ...
                             {{--  <img src="{{ asset('papictures/group-icon.pngth') }}" style="width: 90px;height: 130px;" alt=""> --}}
                              <div  class="div-item-nhom-popup" style="background-image: url('{{ asset($lstNhomQuanLyCuaTaiKhoan[$i]->anh) }}');background-repeat: no-repeat, repeat; background-size:77px auto; background-position: center; " >
                                  <div class="div-name-nhom"  style="height: 35px; width: 120px;text-align: center;margin-left: -37px;margin-top: 53px;overflow: hidden;font-weight: bold;text-overflow: ellipsis;">{{$lstNhomQuanLyCuaTaiKhoan[$i]->ten_nhom}}
                                  </div>
                              </div>
