<div id="js-confirm-change-by-password-modal" class="confirm-change-setting-modal confirm-modal modal">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div>
				<input type="text" id="confirm-password-setting" placeholder="Mật khẩu">
			</div>
			<div>
