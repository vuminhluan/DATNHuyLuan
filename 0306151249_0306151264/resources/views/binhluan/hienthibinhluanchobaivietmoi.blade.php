                    ...
                    <div>
                        <div class="divlikecmt">
                               ...
                               <div class="divbtnlike" onclick="clicklike('div-content-all-cmt-157')">
                                ...
                                <div class="divbtncmt" onclick="clickbinhluan('{{ $lstbaiviett[0]->ma_bai_viet }}')" >
                                    <h3><i class="fa fa-comment-o" aria-hidden="true" ><strong>&ensp;Bình luận</strong></i></h3>
                                </div>

                        </div>
                        {{--tren  --}}
                    <div id="dv-div-big-{{ $lstbaiviett[0]->ma_bai_viet }}" class="div-tatca-cmt" >
                        <div style="margin-left: 12px;margin-right: 12px; height: 12px;"> </div>
                        <div style="margin-left: 12px;margin-right: 12px; height: 30px;"> </div>
                        <div id="div-content-all-cmt-{{ $lstbaiviett[0]->ma_bai_viet }}" style="display: none;border-top: solid 1px #c5cfd6;margin-left: 12px;margin-right: 12px; height: auto;    padding-bottom: 10px"> 
                            {{-- 1 cmt --}}
                        ...
                        {{-- duoi --}}
                        <div class="divcmt" id="div-input-binhluan-{{ $lstbaiviett[0]->ma_bai_viet }}" style="display: none;" >
                            <div>
                                <div class="divimgaccountcmt" >
                                    <img class="imgaccountcmt"  src=" {{ asset('pictures/avt1.jpg') }}" alt="Mountain View" >
                                </div>
                                <div class="divtextcmt" >
                                    <input class="iptextcmt" id="input-binhluan-{{ $lstbaiviett[0]->ma_bai_viet }}" onKeyPress='submitme(event,"{{ $lstbaiviett[0]->ma_bai_viet }}")' style="                               
                                                                    margin-top: 5px;
                                                                    width: 498px;
                                                                    background-color: 
                                                                    white;height: 30px;
